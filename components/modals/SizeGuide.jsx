                ...
                <div className="tab-size">
                  <div>
                    <div className="widget-size mb_16">
                      ...
                      <div className="range-input">
                        <div className="tow-bar-block">
                          <div className="progress-size" style={{ width: `${percentMax1}%` }} />
                        </div>
                        <input type="range" min="0" max={maxRange} value={rangeValue1} onInput={handleRangeInput1} className="range-max" />
                      </div>
                    </div>
                    <div className="widget-size">
                      ...
                      <div className="range-input">
                        <div className="tow-bar-block">
                          <div className="progress-size" style={{ width: `${percentMax2}%` }} />
                        </div>
                        <input type="range" min="0" max={maxRange} value={rangeValue2} onInput={handleRangeInput2} className="range-max" />
                      </div>
                    </div>
                  </div>
                  <div className="size-button-wrap choose-option-list">
                    {options.map((option, index) => (
                      <div key={index} className={`size-button-item choose-option-item ${index === activeIndex ? "select-option" : ""}`} onClick={() => handleClick(index)}>
                        <h5>{option.label}</h5>
                      </div>
                    ))}
                  </div>
                  <div>
                    <h6 className="suggests-title">Giuliana Flores suggests for you:</h6>
