...
export default function Details3({ product = allProducts[0] }) {
  ...
  const { addProductToCart, isAddedToCartProducts, isAddedtoCompareItem, addToWishlist, isAddedtoWishlist, addToCompareItem, cartProducts, updateQuantity } = useContextElement();
  return (
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <Grid2 activeColor={activeColor} setActiveColor={setActiveColor} firstItem={product.images[0]} />
            </div>
            {/* /Product default */}
