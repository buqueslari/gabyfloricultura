...
export default function DetailsColorRoundedImage({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoCompareItem, isAddedtoWishlist, addToCompareItem, cartProducts, updateQuantity } = useContextElement();
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="tf-product-media-wrap sticky-top">
                <Slider1 setActiveColor={setActiveColor} activeColor={activeColor} firstItem={product.images[0]} slideItems={slides3} />
              </div>
            </div>
            {/* /Product default */}
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-choose-option">
                    <ColorSelect5 setActiveColor={setActiveColor} activeColor={activeColor} />
                    <SizeSelect />
