...
export default function DetailsExternal({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToCompareItem, addToWishlist, isAddedtoWishlist, cartProducts, isAddedtoCompareItem, updateQuantity } = useContextElement();
  return (
                  ...
                  <div className="tf-product-info-choose-option">
                    ...
                    <div>
                      <div className="tf-product-info-by-btn mb_10">
                        <a href="#" className="btn-style-5 text-btn-uppercase flex-grow-1 radius-60">
