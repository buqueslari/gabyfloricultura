...
export default function DetailsFixedprice({ product = allProducts[0] }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, addToCompareItem, isAddedtoWishlist, isAddedtoCompareItem, cartProducts, updateQuantity } = useContextElement();
  return (
            ...
            <div className="tf-product-info-list left-desc">
              <div className="tf-product-info-choose-option mb_40">
                ...
                <ul className="tf-product-info-sku">
                  ...
                  <li>
                    ...
                    <p className="text-caption-1 text-1">Giuliana Flores</p>
                  </li>
                  <li>
              ...
              <ul className="accordion-product-wrap" id="accordion-product">
                <li className="accordion-product-item">
                  <a href="#accordion-1" className="accordion-title collapsed current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordion-1">
                    <h6>Description</h6>
                    <span className="btn-open-sub" />
                  </a>
                  <div id="accordion-1" className="collapse" data-bs-parent="#accordion-product">
                ...
                <li className="accordion-product-item">
                  <a href="#accordion-2" className="accordion-title current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordion-2">
                    <h6>Customer Reviews</h6>
                    <span className="btn-open-sub" />
                  </a>
                  <div id="accordion-2" className="collapse show" data-bs-parent="#accordion-product">
                ...
                <li className="accordion-product-item">
                  <a href="#accordion-3" className="accordion-title collapsed current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordion-3">
                    <h6>Shipping &amp; Returns</h6>
                    <span className="btn-open-sub" />
                  </a>
                  <div id="accordion-3" className="collapse" data-bs-parent="#accordion-product">
                ...
                <li className="accordion-product-item">
                  <a href="#accordion-4" className="accordion-title collapsed current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordion-4">
                    <h6>Return Policies</h6>
                    <span className="btn-open-sub" />
                  </a>
                  <div id="accordion-4" className="collapse" data-bs-parent="#accordion-product">
            ...
            <div className="sticky-top">
              <div className="tf-product-info-list right-details">
                <div className="tf-product-info-heading">
                  ...
                  <div className="tf-product-info-desc">
                    <div className="tf-product-info-price">
                      <h5 className="price-on-sale font-2"> ${product.price.toFixed(2)}</h5>
                      {product.oldPrice ? (
                        <>
                          <div className="compare-at-price font-2"> ${product.oldPrice.toFixed(2)}</div>
                ...
                <div className="tf-product-info-choose-option">
                  <ColorSelect setActiveColor={setActiveColor} activeColor={activeColor} />
                  <SizeSelect />
                  ...
                  <div>
                    <div className="tf-product-info-by-btn mb_10">
                      <a onClick={() => addProductToCart(product.id, quantity)} className="btn-style-2 flex-grow-1 text-btn-uppercase fw-6 btn-add-to-cart">
                        <span>{isAddedToCartProducts(product.id) ? "ADICIONADO" : "ADICIONAR -"}</span>
                      ...
                      <a href="#compare" data-bs-toggle="offcanvas" aria-controls="compare" onClick={() => addToCompareItem(product.id)} className="box-icon hover-tooltip compare btn-icon-action">
                        ...
                        <span className="tooltip text-caption-2">{isAddedtoCompareItem(product.id) ? "Already compared" : "Compare"}</span>
                      </a>
                      <a onClick={() => addToWishlist(product.id)} className="box-icon hover-tooltip text-caption-2 wishlist btn-icon-action">
                        <span className="icon icon-heart" />
                        <span className="tooltip text-caption-2">{isAddedtoWishlist(product.id) ? "Already Wishlished" : "Wishlist"}</span>
                      </a>
                    </div>
