...
export default function DetailsGrouped({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, cartProducts, isAddedtoCompareItem, addToCompareItem, updateQuantity } = useContextElement();
