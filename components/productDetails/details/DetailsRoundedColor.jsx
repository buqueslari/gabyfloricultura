...
export default function DetailsRoundedColor({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, isAddedtoCompareItem, cartProducts, updateQuantity, addToCompareItem } = useContextElement();
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-choose-option">
                    <ColorSelect3 setActiveColor={setActiveColor} activeColor={activeColor} />
                    <SizeSelect />
