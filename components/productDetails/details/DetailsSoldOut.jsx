...
export default function DetailsSoldOut({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, isAddedtoCompareItem, cartProducts, addToCompareItem, updateQuantity } = useContextElement();
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-choose-option">
                    <ColorSelect8 setActiveColor={setActiveColor} activeColor={activeColor} />
                    <SizeSelect />
                    ...
                    <div>
                      <div className="tf-product-info-by-btn mb_10">
                        <a href="#shoppingCart" data-bs-toggle="modal" className="btn-style-2 flex-grow-1 text-btn-uppercase fw-6 btn-add-to-cart btn-sold-out">
                          <span>Sold out -&nbsp;</span>
                          <span className="tf-qty-price total-price">${(product.price * quantity).toFixed(2)}</span>
                        </a>
