...
export default function DetailsSubscribeAndSave({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, addToCompareItem, cartProducts, isAddedtoCompareItem, updateQuantity } = useContextElement();
