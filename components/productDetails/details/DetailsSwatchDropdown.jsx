...
export default function DetailsSwatchDropdown({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, addToCompareItem, isAddedtoWishlist, cartProducts, isAddedtoCompareItem, updateQuantity } = useContextElement();
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-choose-option">
                    <ColorSelect6 setActiveColor={setActiveColor} activeColor={activeColor} />
                    <SizeSelect2 />
