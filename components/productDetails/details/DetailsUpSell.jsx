...
export default function DetailsUpSell({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, addToCompareItem, cartProducts, updateQuantity, isAddedtoCompareItem } = useContextElement();
                    ...
                    <div className="tf-product-upsell-slod d-flex justify-content-between gap-16 flex-wrap">
                      ...
                      <div className="tf-product-process-wrap">
                        ...
                        <div className=" d-flex gap-4">
                          ...
                          <div className="text-caption-1 text-secondary">Only 24 item(s) left in stock!</div>
                        </div>
                      </div>
                    </div>
                  </div>
