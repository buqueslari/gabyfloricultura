...
export default function DetailsWithDiscount({ product }) {
  ...
  const { addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, cartProducts, addToCompareItem, updateQuantity, isAddedtoCompareItem } = useContextElement();
                    ...
                    <div className="tf-product-with-discount">
                      ...
                      <div className="tf-product-discount-list">
                        <div className="tf-product-discount-item">
                          ...
                          <div className="tf-btn-discount btn-discount-apply">APPLY</div>
                        </div>
                        <div className="tf-product-discount-item">
                          <svg width={130} height={32} viewBox="0 0 130 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
